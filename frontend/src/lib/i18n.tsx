...
const dict = {
  ...
  admin: {
    ...
    xgboostAccuracy: { fr: 'PRÉCISION XGBOOST', en: 'XGBOOST ACCURACY' },
    errorRate:    { fr: "TAUX D'ERREUR (MAPE)", en: 'ERROR RATE (MAPE)' },
    ...
    apiUptime:    { fr: 'Disponibilité API', en: 'API Uptime' },
    dbStatus:     { fr: 'Base de Données', en: 'Database' },
    auditLedger:  { fr: "Registre d'Audit", en: 'Audit Ledger' },
