...
const dict = {
  ...
  facturation: {
    ...
    billsForecast:{ fr: 'Factures & Prévisions statistiques', en: 'Bills & Statistical Forecasts' },
    ...
    badgeForecast:{ fr: 'PRÉVISION STATISTIQUE', en: 'STATISTICAL FORECAST' },
    ...
    noBills:      { fr: "Aucune facture pour le moment. Importez votre première facture pour démarrer les prévisions statistiques.", en: 'No bills yet. Import your first bill to start statistical forecasts.' },
